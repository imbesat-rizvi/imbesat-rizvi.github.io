...
## Notes
* News section was added with the inputs from [this](https://github.com/wowchemy/wowchemy-hugo-themes/issues/1677) wowchemy github issue.

## Test and build
* Run server for testing - `hugo server`
* Testing with auto-update - `hugo server -D`
* Testing in production environment (helpful to test google analytics) - `env HUGO_ENV="production" hugo server -D`
* Generate production site - `env HUGO_ENV="production" hugo`